(() => {
  ...
  var validateMaybe = function(desc) {
    return function(el) {
      ...
      ;
      throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 488, column 3 - line 490, column 24): " + [el.constructor.name]);
    };
  };
      ...
      return bind22(get3(json)(optionPriceURL(ticker)(curStockPrice)))(function(res) {
        var result = function() {
          ...
          if (res instanceof Right) {
            ...
            ;
            throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 423, column 13 - line 427, column 34): " + [json2.constructor.name]);
          }
          ;
          throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 416, column 9 - line 427, column 34): " + [res.constructor.name]);
        }();
        ...
        if (v2 instanceof RiscLine) {
          return launchAff_(function() {
            ...
            return bind22(fetchUpdatedOptionPrice(v2.value0.ticker)(sp))(function(n) {
              ...
              ;
              throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 439, column 7 - line 443, column 55): " + [n.constructor.name]);
            });
          }());
        }
        ;
  ...
  var handleMouseEventUpLine = function(ct) {
    return function(vr) {
      return function(line) {
        ...
        ;
        throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 449, column 3 - line 453, column 42): " + [line.constructor.name]);
      };
    };
  };
  ...
  var initEvents = function(ct) {
    return function(v) {
      return function __do3() {
        ...
        ;
        throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 517, column 5 - line 529, column 85): " + [context.constructor.name]);
      };
    };
  };
    ...
    return bind22(get3(json)(spotURL(ticker)))(function(res) {
      var result = function() {
        ...
        if (res instanceof Right) {
          ...
          ;
          throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 363, column 13 - line 367, column 28): " + [spot.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 356, column 9 - line 367, column 28): " + [res.constructor.name]);
      }();
      return pure14(result);
    });
  };
    ...
    return bind22(get3(json)(levelLinesURL(ticker)))(function(res) {
      var result = function() {
        ...
        if (res instanceof Right) {
          ...
          ;
          throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 283, column 13 - line 287, column 29): " + [lines3.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 276, column 9 - line 287, column 29): " + [res.constructor.name]);
      }();
      return pure14(result);
    });
  };
    ...
    return bind22($$delete4(json)(levelLinesURL(ticker)))(function(res) {
      var result = function() {
        ...
        if (res instanceof Right) {
          ...
          ;
          throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 325, column 13 - line 329, column 30): " + [status.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 318, column 9 - line 329, column 30): " + [res.constructor.name]);
      }();
      return pure14(result);
    });
  };
  var deleteAll = function(ct) {
    return function(ticker) {
      return applySecond3(clearLines(chartTypeAsInt(ct)))(launchAff_(bind22(deleteAll_(ticker))(function(status) {
        ...
        ;
        throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 339, column 7 - line 343, column 20): " + [status.constructor.name]);
      })));
    };
  };
  ...
  var fetchSpot = function(ct) {
    return function(ticker) {
      return launchAff_(bind22(fetchSpot_(ticker))(function(spot) {
        ...
        ;
        throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 391, column 7 - line 395, column 40): " + [spot.constructor.name]);
      }));
    };
  };
  ...
  var fetchLevelLines = function(ct) {
    return function(ticker) {
      return launchAff_(bind22(fetchLevelLines_(ticker))(function(lines3) {
        ...
        ;
        throw new Error("Failed pattern match at HarborView.Maunaloa.LevelLine (line 297, column 7 - line 305, column 12): " + [lines3.constructor.name]);
      }));
    };
  };
